...
<meta name="keywords" content="<?php foreach ($site->meta_keywords()->split('|') as $meta_keywords): ?><?= $page->meta_keywords()->or($meta_keywords) ?><?php endforeach ?>, <?= $page->meta_title()->or($page->title()) ?>">
<meta id="schema_keywords" itemprop="keywords" content="<?php foreach ($site->meta_keywords()->split('|') as $meta_keywords): ?><?= $page->meta_keywords()->or($meta_keywords) ?><?php endforeach ?>, <?= $page->meta_title()->or($page->title()) ?>">
